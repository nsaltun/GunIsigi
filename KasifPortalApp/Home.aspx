            ...
            <div class="span12">
                <ul class="tiles" style="margin-top: 0px;">
                    ...
                    <li class="orange long">
                        <a href="#"><span><i class="icon-shopping-cart"></i></span><span class="name">Öğrenci Devamsızlık</span></a>
                    </li>
                    <li class="blue">
                    ...
                    <li class="lime long">
                        <a href="#"><span><i class="icon-comment"></i></span><span class="name">Hoca Bilgisi</span></a>
                    </li>
                    <li class="green long">
                        <a href="#"><span><i class="icon-globe"></i></span><span class="name">Ders Haftaları</span></a>
                    </li>
                    <li class="teal long">
