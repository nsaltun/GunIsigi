<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="DevamsizlikBilgisiDuzenle.aspx.cs" Inherits="KasifPortalApp.KasifPages.Forms.DevamsizlikBilgisiDuzenle" %>
    ...
    <script>
        $(document).ready(function () {
            ...
            function CallAjaxOnSubmit(postData)
            {
                $.ajax({
                    type: "POST",
                    url: "<%= ResolveClientUrl("~/KasifPages/Forms/DevamsizlikBilgisiDuzenle.aspx/ProcessOperation") %>",
