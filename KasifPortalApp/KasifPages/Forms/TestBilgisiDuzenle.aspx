<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="TestBilgisiDuzenle.aspx.cs" Inherits="KasifPortalApp.KasifPages.Forms.TestBilgisiDuzenle" %>
    ...
    <script>
        $(document).ready(function () {
            ...
            function CallAjaxOnSubmit(postData)
            {
                $.ajax({
                    type: "POST",
                    url: "<%= ResolveClientUrl("~/KasifPages/Forms/TestBilgisiDuzenle.aspx/ProcessOperation") %>",
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="server">
    <h3>Test Bilgisi Düzenle</h3>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="server">
    <div class="span12">
        <div class="box box-color box-bordered">
            <div class="box-title">
                <h3><i class="icon-list"></i>Test Bilgisi Düzenle</h3>
            </div>
