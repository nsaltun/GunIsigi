<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="TestBilgisiEkle.aspx.cs" Inherits="KasifPortalApp.KasifPages.Forms.TestBilgisiEkle" %>
    ...
    <script>
        $(document).ready(function () {
            ...
            function CallAjaxOnSubmit(postData)
            {
                $.ajax({
                    type: "POST",
                    url: "<%= ResolveClientUrl("~/KasifPages/Forms/TestBilgisiEkle.aspx/ProcessOperation") %>",
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="server">
    <h3>Test Bilgisi Ekle</h3>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="server">
    <div class="span12">
        <div class="box box-color box-bordered">
            <div class="box-title">
                <h3><i class="icon-list"></i>Test Bilgisi Ekle</h3>
            </div>
