<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.Master" AutoEventWireup="true" CodeBehind="HocaBilgisiEkle.aspx.cs" Inherits="KasifPortalApp.KasifPages.Forms.HocaBilgisiEkle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitle" runat="server">
    <h3>Hoca Bilgisi Ekle</h3>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="cphContent" runat="server">
    <div class="span12">
        <div class="box box-color box-bordered">
            <div class="box-title">
                <h3><i class="icon-list"></i>Hoca Ekle</h3>
            </div>
